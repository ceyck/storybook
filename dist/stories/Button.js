...
var Button = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("button", __assign({ type: "button", className: ["storybook-button", "storybook-button--" + size, mode].join(" "), style: { backgroundColor: backgroundColor } }, props, { children: label }), void 0));
};
